...
const DEFAULT_POLICY: PolicyState = {
  compression:{alpha:0.60,beta:0.50,gamma:0.50,theta1:0.30,theta2:0.55},  // synced with src/state/constants.ts
